...
variables in Y_test.txt and Y_train.txt
activity id 

variables in subject_test.txt and subject_train.txt
subject id

variables in features.txt
features names 

variables in activity_labels.txt
...
variables in X_test.txt and X_train.txt
Feature Selection 
